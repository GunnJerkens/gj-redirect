...
class gjRedirectMetabox {

  function __construct() {

    add_action('load-post.php', array(&$this, 'gj_metaboxes'));
    add_action('load-post-new.php', array(&$this, 'gj_metaboxes'));
    add_action('wp_head', array(&$this, 'gj_metaboxes_action'));

  }

  function gj_metaboxes() {
    add_action('add_meta_boxes', array(&$this, 'gj_metaboxes_add'));
    add_action('save_post', array(&$this, 'gj_metaboxes_save_post'), 10, 2);
  }

  // Setup the metabox
  function gj_metaboxes_add() {
    add_meta_box('gj-redirect', 'GJ Redirect', array(&$this, 'gj_metabox_callback'), '', 'side', 'default');
  }
